...
$local_gmt = '<li class="topline"><a href="#"><strong>Your Local:</strong><br /> '.date('d/m/Y \a\t H:i').'</a></li>
			  <li><a href="#"><strong>Your Timezone:</strong> '.getlocaltimezone(1,0,$userID).'</a></li>';
	   ...
	   <li><a href="#" class="menulink">Cup Navigation <img src="images/cup/icons/next.gif" align="right"></a>
	      <ul>
	        ...
	        <li><a href="#" class="sub"><img src="images/cup/icons/time.png">  Date/Timezone</a>	   
				<ul>
				    '.$local_gmt.'
					<li class="topline"><a href="#"><strong>Web Local:</strong><br /> '.date('d/m/Y \a\t H:i').'</a></li>
					<li><a href="#"><strong>Web Timezone:</strong> '.$tz['timezone'].'</a></li>
					<li><a href="#"><img src="images/cup/icons/support.png" width="16" height="16"> Timezone may differ for individual leagues, view league details for info.</a></li>
				</ul>
		</li>
...
//-- Awaiting match action by participant --//
  ...
  if($loggedin)
  { 
     $query_1on1=safe_query("SELECT * FROM ".PREFIX."cup_matches WHERE (clan1='$userID' || clan2='$userID') AND (clan1 != '0' AND clan2 != '0') AND (clan1 !='2147483647' AND clan2 !='2147483647') AND 1on1='1' AND confirmscore='0'");
  ...
  if(!isset($reporting_blk1)) { 
      $reporting_blk1 = null;
  }
  if(!isset($reporting_blk2)) { 
      $reporting_blk2 = null;
  }
  if(!isset($report)) { 
      $report = null;
...
echo '
				<ul>
					...
					<li><a href="?site=myprofile&action=timezone&userID='.$userID.'"><img src="images/cup/icons/time.png" width="16" height="16"> Set Timezone</a></li>
...
if(iscupadmin($userID)) $sh_bt_admin = '<li><a href="admin/admincenter.php?site=cupinfo" target="_blank"><img src="images/cup/icons/manage.gif"> Report Bug</a></li>';
...
echo '    <li><a href="?site=shout"><img src="images/cup/icons/tchat.png" width="16" height="16"> Chat</a></li>
	  ...
	  <li><a href="?site=cupactions&action=mytickets" class="sub"><img src="images/cup/icons/support.png" width="16" height="16"> Help</a>
				<ul>
					<li class="topline"><a href="?site=faq"><img src="images/cup/icons/question.png" width="16" height="16"> FAQ</a></li>
					<li><a href="?site=cupactions&action=mytickets"><img src="images/cup/icons/ticket.png"> My Tickets</a></li>
